...
prob.model.set_input_defaults('thickness', val=0.01, units='m')
...
comp_to_check = 'cantilever.beam_group'
apart_tol = 1.e-6
rpart_tol = 1.e-6
...
check_partials_data = prob.check_partials(method='cs', includes=comp_to_check, show_only_incorrect=True, compact_print=False)
